                        ...
                        <td colspan="3" class="px-6 py-10 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    @if ($search)
                                        Tidak ada program yang cocok dengan kriteria pencarian Anda.
                                    @else
                                        Mulailah dengan membuat program baru.
                                    @endif
                                </p>
                                @if (!$search)
                                    <div class="mt-6">
                ...
                <div
                    ...
                    <form>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div class="mb-4">
                                <label for="description" class="block text-gray-700 text-sm font-bold mb-2">Isi
                                    Konten</label>
                                <div x-data="{
                            ...
                            <div class="mb-4">
                                ...
                                @elseif ($image)
                                    <img src="{{ Storage::url('programs/' . $image) }}" class="mt-2"
                                        style="max-width: 200px;">
                                @endif
                            </div>
                        </div>
