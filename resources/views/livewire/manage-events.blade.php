            ...
            <tbody class="bg-white divide-y divide-gray-100">
                @forelse ($events as $event)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-4 text-sm font-medium text-gray-900">
                                {{ $event->location }} | {{ $event->date->format('d F Y') }} |
                    ...
                    <tr>
                        <td colspan="3" class="px-6 py-10 text-center">
                            <div class="flex flex-col items-center justify-center">
                                <i class="fa-solid fa-calendar text-4xl text-gray-300"></i>
                                <h3 class="mt-2 text-sm font-medium text-gray-900">
                                    Tidak ada acara yang ditemukan
                                </h3>
                                <p class="mt-1 text-sm text-gray-500">
                                    @if ($search)
                                        Tidak ada acara yang cocok dengan kriteria pencarian Anda.
                                    @else
                                        Mulailah dengan membuat acara baru.
                                    @endif
                                </p>
                                @if (!$search)
                                    <div class="mt-6">
                    ...
                    <form>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div class="mb-4">
                                ...
                                @elseif ($image)
                                    <img src="{{ Storage::url('events/' . $image) }}" class="mt-2"
                                        style="max-width: 200px;">
                                @endif
                            </div>
                            <div class="mb-4">
