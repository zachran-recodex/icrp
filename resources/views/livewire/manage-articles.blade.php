                                ...
                                <div class="flex-shrink-0 h-20 w-20">
                                    @if ($article->image)
                                        <img class="h-20 w-20 rounded-lg object-cover"
                                            src="{{ Storage::url('articles/' . $article->image) }}"
                                            alt="{{ $article->title }}">
                                    @else
                        ...
                        <td colspan="3" class="px-6 py-10 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900">
                                    Tidak ada berita & artikel yang ditemukan
                                </h3>
                                <p class="mt-1 text-sm text-gray-500">
                                    @if ($search)
                                        Tidak ada berita & artikel yang cocok dengan kriteria pencarian Anda.
                                    @else
                                        Mulailah dengan membuat berita & artikel baru.
                                    @endif
                                </p>
                                @if (!$search)
                                    <div class="mt-6">
                    ...
                    <form>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div class="mb-4">
                                ...
                                @elseif ($image)
                                    <img src="{{ Storage::url('articles/' . $image) }}" class="mt-2"
                                        style="max-width: 200px;">
                                @endif
                            </div>
                        </div>
