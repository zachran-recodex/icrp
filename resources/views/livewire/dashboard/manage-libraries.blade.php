                ...
                @forelse ($this->libraries as $library)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            ...
                            <!-- Edit -->
                            <flux:button icon="pencil" wire:click="editLibrary({{ $library->id }})" size="sm" variant="primary" color="blue" />

                            <!-- Delete -->
                            <flux:button icon="trash" wire:click="deleteLibrary({{ $library->id }})" size="sm" variant="primary" color="red" />
