                ...
                <div class="lg:w-1/3">
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden sticky top-8">
                        ...
                        <div class="p-6">
                            ...
                            @if($member->nickname)
                                <p class="text-primary-600 font-medium mb-4">"{{ $member->nickname }}"</p>
                            @endif
                            ...
                            <!-- Category Badge -->
                            @if($member->dewan_category)
                                <div class="mb-4">
                                    <span class="inline-block px-3 py-1 bg-primary-100 text-primary-700 text-sm rounded-full">
                                        {{ ucwords($member->dewan_category) }}
                                    </span>
                                </div>
                            @endif
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-gray-600">
                                                {{ $member->birth_place ? $member->birth_place . ', ' : '' }}{{ $member->birth_date->format('d F Y') }}
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if($member->death_date)
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-gray-600">
                                                {{ $member->death_date->format('d F Y') }} ({{ $member->age }} tahun)
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if($member->known_as)
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-gray-600">{{ $member->known_as }}</div>
                                        </div>
                                    </div>
                                @endif
                            </div>
